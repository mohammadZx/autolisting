...
if (_updateIsAvailable()) {
	$cachedFiles = [
		realpath(__DIR__ . '/../../ad/bootstrap/cache/packages.php'),
		realpath(__DIR__ . '/../../ad/bootstrap/cache/services.php'),
	];
...
$unsupportedCachedFiles = [
	realpath(__DIR__ . '/../../ad/bootstrap/cache/config.php'),
	realpath(__DIR__ . '/../../ad/bootstrap/cache/routes.php'),
];
...
function _getComposerRequiredPhpVersion()
{
	...
	$filePath = realpath(__DIR__ . '/../../ad/composer.json');
...
{
	$configFilePath = realpath(__DIR__ . '/../../ad/config/app.php');
...
function _getDotEnvValue($key): ?string
{
	...
	$filePath = realpath(__DIR__ . '/../../ad/.env');
...
{
	$envFile = realpath(__DIR__ . '/../../ad/.env');
	$installedFile = realpath(__DIR__ . '/../../ad/storage/installed');
