...
Route::get('send-code/{phone}', [\App\Http\Controllers\Web\Auth\ForceAuthController::class, 'sendCode'])->name('send-code');
Route::post('code-login', [\App\Http\Controllers\Web\Auth\ForceAuthController::class,'logincode'])->name('login-code');
